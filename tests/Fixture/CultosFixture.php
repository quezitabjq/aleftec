 ...
 *
 */
class CultosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'diadasemana' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-03-21 17:44:56',
            'modified' => '2018-03-21 17:44:56'
        ],
    ];
}
